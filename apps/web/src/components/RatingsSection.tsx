...
export function RatingsSection() {
	...
	if (isLoading) {
		return (
			<div className='p-6 text-center text-ivory-dim'>Loading ratings...</div>
		);
	}
	...
	if (ratings.length === 0) {
		return (
			<div className='p-6 text-center text-ivory-dim'>
	...
	return (
		<div className='space-y-4'>
			<h3 className='text-xl font-semibold text-ivory mb-4'>Your Ratings</h3>
			<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
				{ratings.map(rating => (
					...
					>
						...
						<div className='grid grid-cols-4 gap-2 text-sm text-ivory-dim'>
							<div>
								<span className='block text-xs text-ivory-dim mb-0.5'>
									Games
								</span>
