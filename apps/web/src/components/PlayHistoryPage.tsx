        ...
        const loadHistory = async () => {
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(
                        data?.error ||
                            'Unable to load your play history. Please try again.'
                    );
                }
                ...
                setHistory(
                    Array.isArray(data.playHistory) ? data.playHistory : []
                );
            } catch (fetchError) {
                if (
            ...
            <div className='min-h-[70vh] flex items-center justify-center'>
                <div className='glass-effect rounded-3xl px-10 py-14 text-center space-y-4 max-w-md w-full'>
                    ...
                    <p className='text-purple-100/80'>
                        Your recent games and results will appear here once you
                        are logged in.
                    </p>
                    <button
                        type='button'
            ...
            <div className='container mx-auto px-4 py-12 space-y-8 max-w-6xl'>
                <header className='space-y-4'>
                    ...
                    <p className='text-purple-100/80 max-w-2xl'>
                        Review your recent matches across every variant, monitor
                        your results, and spot trends in your progress.
                    </p>
                </header>
                ...
                <section className='glass-effect rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/10'>
                    ...
                    {isLoading ? (
                        ...
                        <div className='py-16 text-center space-y-3 text-purple-100/70'>
                            ...
                            <p>
                                Play against an AI or a friend to start your
                                history.
                            </p>
                        </div>
                    ) : (
