...
test.describe('Chess AI Integration', () => {
    ...
    test('should display AI configuration panel and handle provider switching', async ({
        ...
        await page
            .getByRole('button', { name: 'OpenRouter gpt-oss-120b' })
            .click();
    ...
    test('should display correct game mode states and AI information', async ({
        ...
        await expect(
            page.getByRole('button', { name: /AI vs Human/ })
        ).toHaveClass(/border-pink-400/);
    });

    test('should handle provider model switching correctly', async ({
        page,
    }) => {
        ...
        await expect(
            page.getByText('OpenRouter - claude-3-haiku')
        ).toBeVisible();
    ...
    test('should display proper game instructions for AI modes', async ({
        ...
        await expect(
            page.getByText('Click on a piece to select it')
        ).toBeVisible();
